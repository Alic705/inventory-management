    ...
    <div className="p-4 sm:p-6 md:p-8 space-y-4 md:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Manage your inventory and pricing.</p>
        </div>
          ...
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow>
                ...
                <TableHead className="min-w-[110px]">Purchase Rate</TableHead>
                <TableHead className="min-w-[100px]">Sale Rate</TableHead>
